...
import com.example.projectdemo.databinding.FragmentWatchBinding
...
@AndroidEntryPoint
class WatchFragment : Fragment(), RecycleviewAdapter.InterfaceClickListener {
    ...
    override fun onCreateView(
        ...
        _binding =
            DataBindingUtil.inflate(layoutInflater, R.layout.fragment_watch, container, false)
...
//        navController = Navigation.findNavController(view)
        ...
        binding.apply {
            deshboardLayoutId.setSafeOnClickListener {
                val actionWatchFragment=WatchFragmentDirections.actionWatchFragment3ToDeshBoardFragment3()
                findNavController().navigate(actionWatchFragment)
            }
            mediaLibraryLayoutId.setSafeOnClickListener {
                val actionMediaFragment=WatchFragmentDirections.actionWatchFragment3ToMediaLibraryFragment()
                findNavController().navigate(actionMediaFragment)
            }
        }
        init()
    ...
    private fun setColor() {
        binding.apply {
            ...
            watchTxtId.setTextColor(ContextCompat.getColor(requireContext(), R.color.yellow))
    ...
    private fun recycleviewFun(movieList: ArrayList<MovieModelClass>) {
        ...
        recyclerViewAdapter =
            RecycleviewAdapter(requireContext(), movieList, R.layout.watch_item_list, this)
    ...
    override fun moviePlayer(movieModelListPosition: MovieModelClass, position: Int) {
        val actionInterfaceMoviewPlayer =
            WatchFragmentDirections.actionWatchFragment3ToMoviePlayerFragment(movieModelListPosition)
